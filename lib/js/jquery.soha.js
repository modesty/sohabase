...
(function (factory) {
    ...
    var _generic_error_service = "Sorry, we're in the middle of maintenance, please try again later.";
    ...
    SvcHelper.prototype.getXHRErrorMsg = function(xhr) {
        ...
        try {errMsg = xhr.responseText || xhr.statusText;}catch(err) {errMsg = _generic_error_msg;}
        return errMsg;
    };
